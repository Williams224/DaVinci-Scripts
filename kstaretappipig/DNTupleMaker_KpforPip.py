...
tuple.addBranches({'Kstar' : '[B0 -> ^(K*(892)0 -> pi+ pi-) (eta_prime -> pi- pi+ gamma)]CC',
                   'eta_prime' : '[B0 -> (K*(892)0 -> pi+ pi-) ^(eta_prime -> pi- pi+ gamma)]CC',
                   'Kplus' : '[B0 -> (K*(892)0 -> ^pi+ pi-) (eta_prime -> pi- pi+ gamma)]CC',
                   'piminus' : '[B0 -> (K*(892)0 -> pi+ ^pi-) (eta_prime -> pi- pi+ gamma)]CC',
                   'piplus' : '[B0 -> (K*(892)0 -> pi+ pi-) (eta_prime -> pi- ^pi+ gamma)]CC',
                   'piminus0' : '[B0 -> (K*(892)0 -> pi+ pi-) (eta_prime -> ^pi- pi+ gamma)]CC',
                   'gamma' : '[B0 -> (K*(892)0 -> pi+ pi-) (eta_prime -> pi- pi+ ^gamma)]CC'})
...
preamble=[
    ...
    'SUMTRACK_PT= SUMTREE((211 == ABSID)|(-211 == ABSID),PT)',
    'SUM_PCHI2= SUMTREE((211 == ABSID)|(-211 == ABSID),TRPCHI2)'
    ]
