...
tuple.addTool(TupleToolDecay,name="rho")
...
tuple.Lambda_b0.addTupleTool('TupleToolDecayTreeFitter/DTF')
tuple.Lambda_b0.DTF.Verbose=True
tuple.Lambda_b0.DTF.constrainToOriginVertex=True
tuple.Lambda_b0.DTF.daughtersToConstrain = ["eta_prime"]
