...
#tuple.Lambda_b0.ConsAll.daughtersToConstrain = ["p+","K-","eta_prime"]
...
#==============================REFIT WITH ONLY ETA_PRIME AND PV CONSTRAINED==========================
...
tuple.Lambda_b0.PVFit.daughtersToConstrain = ["eta_prime","p+","K-"]
#==============================REFIT WITH ONLY eta_prime CONSTRAINED===================================
...
tuple.Lambda_b0.KStarOnly.daughtersToConstrain = ["eta_prime"]
...
tuple.Lambda_b0.NoPVFit.daughtersToConstrain = ["eta_prime","p+","K-"]
...
tuple.addBranches({
    'proton' : '[Lambda_b0 -> ^p+ K- (eta_prime -> pi+ pi- gamma)]CC',
    'Kminus' : '[Lambda_b0 -> p+ ^K- (eta_prime -> pi+ pi- gamma)]CC',
...
eta_prime_hybrid=tuple.eta.addTupleTool('LoKi::Hybrid::TupleTool/LoKi_eta')
...
mctuple.Decay="[Lambda_b0 -> ^p+ ^K- ^(eta_prime -> ^pi+ ^pi- ^(pi0 -> ^gamma ^gamma))]CC"
